...
extern class AudioOutput extends ddf.minim.AudioSource, implements ddf.minim.Effectable, implements ddf.minim.Recordable /**, implements ddf.minim.Polyphonic*/ {
	...
	public function new(synthesizer:ddf.minim.spi.AudioSynthesizer):Void;
